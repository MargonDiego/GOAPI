...
// ipKey es un tipo privado para la direcciÃ³n IP del cliente.
type ipKey struct{}
...
// Debe llamarse en los handlers antes de invocar servicios que requieren auditorÃ­a.
...
// WithIP inyecta la direcciÃ³n IP del cliente en el contexto.
